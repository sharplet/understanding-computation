...
println("/\(pattern)/")
println(pattern.toNFADesign().test(string: ""))
println(pattern.toNFADesign().test(string: "a"))
println(pattern.toNFADesign().test(string: "aa"))
println(pattern.toNFADesign().test(string: "aaa"))
println(pattern.toNFADesign().test(string: "ab"))
println(pattern.toNFADesign().test(string: "abab"))
println(pattern.toNFADesign().test(string: "ababab"))
println(pattern.toNFADesign().test(string: "aba"))
println(pattern.toNFADesign().test(string: "aab"))
println(pattern.toNFADesign().test(string: "abb"))
println(pattern.toNFADesign().test(string: "abc"))
